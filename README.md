...
| 版本 | 计划 | 状态 |
|:----:|------|:----:|
| v0.1.0 | 基础 IndexMap + IndexSet + fingerprint | ✅ 已发布 |
| v0.2.0 | 全部 12 种结构 + CI/CD + 中英 README | ✅ 已发布 |
| v0.2.2 | 代码重构 + 质量优化 + mooncakes 发布 | ✅ 已发布 |
| v0.3.0 | 序列化/反序列化支持 + 批量操作优化 | 📅 计划中 |
| v0.4.0 | 原子批处理（multi-key ops） | 📅 计划中 |
| v0.5.0 | 持久化存储后端 + 快照能力 | 📅 计划中 |
